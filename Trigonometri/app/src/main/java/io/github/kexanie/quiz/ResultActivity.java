    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      //  bar.setStepSize(0.5f);
       // bar.setEnabled(false);
        ...
        int salah = 30 - b.getInt("score");
        int nilaitotal = (b.getInt("score") *100) / 30;
       ...
       // ArrayAdapter<String> adapter = new ArrayAdapter<String>(this,android.R.layout.simple_list_item_1,stringjawab);
        ...
        tvTotalNilai.setText("Nilai Anda: " + nilaitotal);
    ...
    public boolean onOptionsItemSelected(MenuItem item){
        switch (item.getItemId()){
            case android.R.id.home:
                Intent i = new Intent(ResultActivity.this, beranda.class);
