...
public class tujuanpembelajaran extends AppCompatActivity {
    ...
    String tex =
            "<table width=\"100%\" border=\"0\" cellpadding=\"1\" cellspacing=\"0\">\n" +
                    ...
                    "    <td width=\"81%\">Menemukan konsep perbandingan trigonometri pada segitiga siku-siku.</td>\n" +
                    "  </tr>\n" +
                    "  <tr>\n" +
                    ...
                    "    <td valign=\"top\">:</td>\n" +
                    "    <td>Membuktikan  sudut istimewa dengan menggunakan rumus hubungan antar perbandingan.</td>\n" +
                    "  </tr>\n" +
                    "  <tr>\n" +
                    "    <td valign=\"top\">3.18.2</td>\n" +
                    "    <td valign=\"top\">:</td>\n" +
                    "    <td>Membuktikan  identitas`trigonometri sederhana dengan menggunakan rumus hubungan antara  perbandingan trigonometri.</td>\n" +
                    "  </tr>\n" +
                    "  <tr>\n" +
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbartujuanpembelajaran);
    ...
    protected void onResume() {
        super.onResume();
        tex_tujuan = (MathView) findViewById(R.id.web_tujuanpembelajaran);
    ...
    public boolean onOptionsItemSelected(MenuItem item){
        switch (item.getItemId()){
            case android.R.id.home:
                buttonmusic();
                Intent i = new Intent(tujuanpembelajaran.this, pendahuluan.class);
                i.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK|Intent.FLAG_ACTIVITY_CLEAR_TASK);
                startActivity(i);
                return (true);
            case R.id.beranda:
                buttonmusic();
                Intent intenberanda = new Intent(tujuanpembelajaran.this, beranda.class);
    ...
    public void onBackPressed() {
        Intent back = new Intent(tujuanpembelajaran.this, pendahuluan.class);
